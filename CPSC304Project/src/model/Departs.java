...
public class Departs {
	...
	public Departs(int train_id, String station_name, String location, Timestamp sched_time, Timestamp actual_time) {
		super();
	...
	public static Departs fromResultSet(ResultSet rs) throws SQLException {
        ...
        return new Departs(train_id, location, station_name, sched_time, actual_time );
    }
}
